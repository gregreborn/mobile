...
import com.example.atelier4.ui.theme.Atelier4Theme
...
class MainActivity : ComponentActivity() {
                    ...
                    Column(modifier = Modifier.padding(all = 16.dp)) {
                        ...
                        TextField(
                            ...
                            onValueChange = { newText ->
                                ...
                                updateTotalBill(
                                    billText,
                                    sliderValueTip.value,
                                    checkedState.value,
                                    totalBill,
                                    sliderValuePeople.value
                                )
                            },
    ...
    private fun updateTotalBill(
        ...
        val billPerPeople = sliderValue2
