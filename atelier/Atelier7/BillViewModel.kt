...
import com.example.atelier7.database.AppDatabase
import com.example.atelier7.database.TransactionBill
import com.example.atelier7.database.TransactionDao
...
class BillViewModel (application: Application) : ViewModel() {
    ...
    fun updateTransactionById(transactionId: Int){
        viewModelScope.launch(Dispatchers.IO) {
           val transactionById = transactionDAO.getTransactionById(transactionId)
            ...
            transactionById.billAmount = billAmountText
            transactionById.isTaxAdded = shouldAddTax
            transactionById.tipPercentage = tipPercentageValue
            transactionById.totalBill = totalBillValue
            transactionById.numberOfPeople = numberOfPeopleValue

            transactionDAO.updateTransaction(transactionById)
        }
    }
